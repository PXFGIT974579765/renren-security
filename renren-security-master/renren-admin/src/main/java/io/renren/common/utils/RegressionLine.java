 ...
 * RegressionLine line = new RegressionLine();  
        ...
        line.addDataPoint(new DataPoint(5, 147));
        line.addDataPoint(new DataPoint(6, 151));
        line.addDataPoint(new DataPoint(7, 121));
        line.addDataPoint(new DataPoint(8, 130));
        line.addDataPoint(new DataPoint(9, 145));
        line.addDataPoint(new DataPoint(10, 155));
        printSums(line);  
        printLine(line);  
 * @author ryanyang
 *
...
public class RegressionLine // implements Evaluatable
{
	...
	public double getR() {
		...
		for (int i = 0; i < pn - 1; i++) {
			double Yi = (float) Integer.parseInt(listY.get(i).toString());
